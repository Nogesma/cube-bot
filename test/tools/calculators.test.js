...
test('contains correct values', () => {
  ...
  expect(averageOfFiveCalculator([Infinity, 4, Infinity, 3, 6])).toBe(Infinity);
...
// getPB
test('return an object with lowest single and average properties', () => {
  expect(
    getPB([
      {
        solves: ['12.76', '15.90', '18.20', 'DNF', '14.39'],
        average: 16.16,
        single: 12.76,
        event: '333',
      },
      {
        solves: ['12.23', '12.28', '15.84', '12.44', '9.81'],
        average: 12.32,
        single: 9.81,
        event: '333',
      },
      {
        solves: ['13.14', '14.27', '14.82', '16.92', '15.00'],
        average: 14.7,
        single: 13.14,
        event: '333',
      },
    ])
  ).toEqual({ single: '9.81', average: '12.32' });
});
